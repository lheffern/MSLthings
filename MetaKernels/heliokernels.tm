KPL/MK
    ...
    This is the meta-kernel used for Mars, MAVEN, MSL, STEREO-A
    ...
    STEREO-A_merged.bsp         STEREO-A SPK
    naif.jpl.nasa.gov_pub_naif_MSL_kernels_pck_pck00008.tpc.txt
                                PCK for MSL

    \begindata
    PATH_VALUES     = ('/Users/lheffern/PycharmProjects/SPICEworkshop/heliokernels')
    ...
    KERNELS_TO_LOAD = ( '$KERNELS/lsk/naif0008.tls',
                        ...
                        '$KERNELS/spk/STEREO-A_merged.bsp'
                        '$KERNELS/pck/+',
                        'naif.jpl.nasa.gov_pub_naif_MSL_kernels_pck_pck00008.tpc.txt')
